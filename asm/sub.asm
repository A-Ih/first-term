...
; result:
;    two's complement negation of long is written to rdi
negate_long:
                push            rax
                push            rdi
                push            rcx
.loop:
                ...
                pop             rcx
                pop             rdi
                mov             rax, 1  ; short number to be added
                call            add_long_short
                pop             rax
                ret
...
is_zero:
                ...
                xor             rax, rax
                rep scasq  ; i don't know why REP is used here, REPE also passed all tests
